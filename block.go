...
func (s *Section) addMarkdownFieldText(field string) {
	s.text = NewMrkdwnText(field)
...
// AddMrkdownField adds a field text to the section.
func (s Section) AddMrkdownFieldText(field string) Section {
	s.addMarkdownFieldText(field)
	return s
}
